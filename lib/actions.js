...
function Actions() {
    ...
    // not sure about this but it keeps clean the Actions instance
...
// Actions is an Array
Actions.prototype.__proto__ = Array.prototype
...
Actions.prototype.change = function (id, to) {
    if (this.items[id] || this.items[id] === 0) {
        this.items[to] = this.items[id]
        delete this.items[id], this._latest = to
        return true
    }
...
Actions.prototype.valid = function () {
    var valid = Object.keys(this.items).map(function(item, index) {
